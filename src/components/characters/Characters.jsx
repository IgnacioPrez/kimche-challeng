...
const Characters = ({
  ...
  return (
    <div
      className="w-[80%] flex items-center gap-5 justify-center flex-wrap min-h-[80vh] max-h-[80vh] overflow-y-auto  md:min-h-[80vh] md:max-h-[80vh] xl:min-h-[100vh] xl:max-h-[100vh] lg:min-h-[70vh] lg:max-h-[70vh]"
